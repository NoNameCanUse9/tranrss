...
---
### 🌐 [在线演示 / Demo](https://demo.384058.xyz/)
> **账号**: `admin`  
> **密码**: `admin`
---
...
1.  **修改默认密码**：系统首次启动会自动创建账号 `admin / admin`。请在登录后立即前往**设置**修改密码。
2.  **强制 HTTPS**：TranRSS 本身不提供 TLS/HTTPS。在公网环境下，请务必使用 **Nginx**, **Caddy** 或 **Traefik** 等反向代理工具，并配置 SSL 证书。
